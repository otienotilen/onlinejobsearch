...
<div class="col-sm-6 content-body" > 
	...
	<div class="col-sm-6">
		<ul>
            ...
            <li><i class="fp-ht-food"></i>Monthly Salary in USD: <?php echo number_format($job->SALARIES,2);  ?></li>
            <li><i class="fa fa-sun-"></i>Years of Experience : <?php echo $job->DURATION_EMPLOYEMENT; ?></li>
        </ul>
	</div> 
	<div class="col-sm-6">
		<ul> 
...
<div class="col-sm-6 content-body" >
	...
	<ul> 
		<li>Country of residence : <?php echo $appl->ADDRESS; ?></li>
...
<p><i class="fa fa-paperclip"></i>  Attachment Files</p>
	...
	<div class="col-sm-12 slider">
		 <h3>Download Identification Card Front <a href="<?php echo web_root.'applicant/'.$attachmentfile->IDFRONT; ?>">Here</a></h3>
	</div> 
	<div class="col-sm-12 slider">
		 <h3>Download Identification Card Back <a href="<?php echo web_root.'applicant/'.$attachmentfile->IDBACK; ?>">Here</a></h3>
	</div> 
