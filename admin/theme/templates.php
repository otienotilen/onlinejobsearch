...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="<?php echo web_root;?>/admin/" class="logo">
      ...
      <span class="logo-mini"><b>HireNetwork International</b></span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b>HireNetwork International</b></span>
    </a>
 ...
 <div class="modal fade" id="menuModal" tabindex="-1">
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2015 <a href="#">HireNetwork International</a>.</strong> All rights
    reserved.
  </footer>
