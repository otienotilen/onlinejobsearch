<section id="content">
		...
		<div class="row"> 
			...
			<div class="form-group">
			 ...
			 <div class="form-group">
			    <div class="col-md-8">
			      <label class="col-md-4 control-label" for=
			      "BIRTHPLACE">Country of Residence:</label>

			      <div class="col-md-8">
			        
			         <textarea class="form-control input-sm" id="BIRTHPLACE" name="BIRTHPLACE" placeholder=
			            "Place of Residence" type="text" value="" required  onkeyup="javascript:capitalize(this.id, this.value);" autocomplete="off"></textarea>
			      </div>
			    </div>
			  </div> 
  ...
  <div class="col-md-11">
    <label class="col-md-4 control-label" for=
    "DEGREE">Identification Card Front:</label>
...
<div class="form-group">
  <div class="col-md-11">
    <label class="col-md-4 control-label" for=
    "DEGREE">Identification Card Back:</label>
